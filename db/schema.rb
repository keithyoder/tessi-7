...
ActiveRecord::Schema[7.2].define(version: 20_260_116_112_355) do
  ...
  create_table 'atendimentos', force: :cascade do |t|
    ...
    t.datetime 'fechamento', precision: nil
  ...
  create_table 'cidades', force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: nil, null: false
    t.datetime 'updated_at', precision: nil, null: false
    t.index %w[estado_id nome], name: 'index_cidades_on_estado_id_and_nome', unique: true
  ...
  create_table 'conexao_enviar_atributos', force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: nil, null: false
    t.datetime 'updated_at', precision: nil, null: false
    t.index %w[conexao_id atributo], name: 'index_conexao_enviar_atributos_on_conexao_id_and_atributo', unique: true
  ...
  create_table 'conexao_verificar_atributos', force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: nil, null: false
    t.datetime 'updated_at', precision: nil, null: false
    t.index %w[conexao_id atributo], name: 'index_conexao_verificar_atributos_on_conexao_id_and_atributo',
                                     unique: true
  ...
  create_table 'conexoes', force: :cascade do |t|
    ...
    t.index ['logradouro_id'], name: 'index_conexoes_on_logradouro_id'
  ...
  create_table 'faturas', force: :cascade do |t|
    ...
    t.bigint 'baixa_id'
    t.datetime 'cancelamento', precision: nil
    t.string 'pix'
    t.string 'id_externo'
    t.string 'link'
    ...
    t.index %w[meio_liquidacao liquidacao], name: 'index_faturas_on_meio_liquidacao_and_liquidacao'
    t.index %w[pagamento_perfil_id nossonumero], name: 'index_faturas_on_pagamento_perfil_id_and_nossonumero'
  ...
  create_table 'nf21s', force: :cascade do |t|
    ...
    t.index ['numero'], name: 'index_nf21s_on_numero', unique: true
  end

  create_table 'nfcom_notas', force: :cascade do |t|
    t.integer 'serie', default: 1, null: false
    t.integer 'numero', null: false
    t.string 'chave_acesso', limit: 44
    t.string 'protocolo', limit: 24
    t.text 'xml_autorizado'
    t.string 'status', default: 'pending', null: false
    t.datetime 'data_autorizacao'
    t.string 'mensagem_sefaz'
    t.bigint 'fatura_id'
    ...
    t.index %w[serie numero], name: 'index_nfcom_notas_on_serie_and_numero', unique: true
  ...
  create_table 'plano_enviar_atributos', force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: nil, null: false
    t.datetime 'updated_at', precision: nil, null: false
    t.index %w[plano_id atributo], name: 'index_plano_enviar_atributos_on_plano_id_and_atributo', unique: true
  ...
  create_table 'plano_verificar_atributos', force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: nil, null: false
    t.datetime 'updated_at', precision: nil, null: false
    t.index %w[plano_id atributo], name: 'index_plano_verificar_atributos_on_plano_id_and_atributo', unique: true
  ...
  add_foreign_key 'conexoes', 'logradouros'
