...
ActiveRecord::Schema[7.2].define(version: 2026_02_15_100521) do
  ...
  create_table "device_backups", force: :cascade do |t|
    t.text "config", null: false
    t.string "checksum", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.bigint "device_id", null: false
    t.index ["device_id"], name: "index_device_backups_on_device_id"
  end
  ...
  create_table "devices", force: :cascade do |t|
    ...
    t.index ["deviceable_type", "deviceable_id"], name: "index_devices_on_deviceable_type_and_deviceable_id", unique: true
    t.index ["equipamento_id"], name: "index_devices_on_equipamento_id"
    t.index ["mac"], name: "index_devices_on_mac"
    t.index ["properties"], name: "index_devices_on_properties", using: :gin
  ...
  create_table "radacct", primary_key: "radacctid", force: :cascade do |t|
    ...
    t.index ["username", "acctstarttime"], name: "index_radacct_on_username_and_acctstarttime"
  ...
  add_foreign_key "device_backups", "devices"
  add_foreign_key "devices", "equipamentos"
